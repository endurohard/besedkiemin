import{c as $,u as P,g as T,r as b,a as R,b as q,j as e,L as f,C as S,k as L,I as M,B as x,S as d,P as I,D as C,m as D,E as N}from"./index-Cy-QnbLZ.js";import{S as G}from"./search-CcdtP__8.js";import{X as F}from"./x-circle-DvffyjO_.js";import{f as A,r as E}from"./ru-3osNYxol.js";/**
 * @license lucide-react v0.309.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q=$("Printer",[["polyline",{points:"6 9 6 2 18 2 18 9",key:"1306q4"}],["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["rect",{width:"12",height:"8",x:"6",y:"14",key:"5ipwut"}]]),W=s=>{const i=window.open("","_blank");if(!i){alert("Не удалось открыть окно печати. Проверьте настройки блокировки всплывающих окон.");return}const h=`
    <!DOCTYPE html>
    <html>
      <head>
        <meta charset="UTF-8">
  ...
  `;i.document.write(h),i.document.close(),i.onload=()=>{setTimeout(()=>{i.print()},250)}},K=()=>{const s=P(),{user:i}=T(),[h,n]=b.useState(null),[l,_]=b.useState(""),[r,y]=b.useState("ALL"),{data:p,isLoading:j,error:w}=R({queryKey:["shipments"],queryFn:N.getAll,refetchInterval:3e4}),u=q({mutationFn:({id:t,status:a})=>N.updateStatus(t,{status:a}),onSuccess:()=>{s.invalidateQueries({queryKey:["shipments"]})}}),g=b.useMemo(()=>p?p.filter(t=>{const a=l===""||t.customerName.toLowerCase().includes(l.toLowerCase())||t.customerPhone.includes(l)||t.deliveryAddress.toLowerCase().includes(l.toLowerCase())||t.items.some(c=>{var m;return(((m=c.inventoryItem)==null?void 0:m.name)||"").toLowerCase().includes(l.toLowerCase())}),o=r==="ALL"||t.status===r;return a&&o}):[],[p,l,r]),z=async t=>{try{n(t);const a=await N.getWaybillData(t);W(a)}catch(a){console.error("Ошибка при получении данных путевого листа:",a),alert("Не удалось загрузить данные для печати")}finally{n(null)}},v=(t,a)=>{confirm("Изменить статус отгрузки?")&&u.mutate({id:t,status:a})},k=t=>{const a={PENDING:{label:"Ожидает",color:"bg-yellow-100 text-yellow-800",icon:I},IN_TRANSIT:{label:"В пути",color:"bg-blue-100 text-blue-800",icon:C},DELIVERED:{label:"Доставлено",color:"bg-green-100 text-green-800",icon:D},CANCELLED:{label:"Отменено",color:"bg-red-100 text-red-800",icon:F}},o=a[t]||a.PENDING,c=o.icon;return e.jsxs("span",{className:`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${o.color}`,children:[e.jsx(c,{className:"w-3 h-3"}),o.label]})};return j?e.jsx("div",{className:"flex items-center justify-center h-64",children:e.jsx(f,{className:"w-8 h-8 animate-spin"})}):w?e.jsx("div",{className:"p-4 bg-red-50 text-red-800 rounded-lg",children:"Ошибка загрузки отгрузок"}):e.jsxs("div",{className:"space-y-4 p-4",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold",children:"Отгрузки со склада"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Управление отгрузками и печать путевых листов"})]}),e.jsx(S,{children:e.jsx(L,{className:"p-4",children:e.jsxs("div",{className:"flex flex-wrap gap-3",children:[e.jsx("div",{className:"flex-1 min-w-[250px]",children:e.jsxs("div",{className:"relative",children:[e.jsx(G,{className:"absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4"}),e.jsx(M,{placeholder:"Поиск по клиенту, адресу, товару...",value:l,onChange:t=>_(t.target.value),className:"pl-9"})]})}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(x,{variant:r==="ALL"?"default":"outline",onClick:()=>y("ALL"),size:"sm",children:"Все"}),e.jsx(x,{variant:r===d.PENDING?"default":"outline",onClick:()=>y(d.PENDING),size:"sm",children:"Ожидает"}),e.jsx(x,{variant:r===d.IN_TRANSIT?"default":"outline",onClick:()=>y(d.IN_TRANSIT),size:"sm",children:"В пути"}),e.jsx(x,{variant:r===d.DELIVERED?"default":"outline",onClick:()=>y(d.DELIVERED),size:"sm",children:"Доставлено"})]})]})})}),e.jsx(S,{children:e.jsxs(L,{className:"p-0",children:[e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"w-full text-sm",children:[e.jsx("thead",{className:"bg-gray-50 border-b",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-4 py-3 text-left font-medium text-gray-600",children:"Дата"}),e.jsx("th",{className:"px-4 py-3 text-left font-medium text-gray-600",children:"Заказ"}),e.jsx("th",{className:"px-4 py-3 text-left font-medium text-gray-600",children:"Статус"}),e.jsx("th",{className:"px-4 py-3 text-left font-medium text-gray-600",children:"Клиент"}),e.jsx("th",{className:"px-4 py-3 text-left font-medium text-gray-600",children:"Телефон"}),e.jsx("th",{className:"px-4 py-3 text-left font-medium text-gray-600",children:"Адрес"}),e.jsx("th",{className:"px-4 py-3 text-left font-medium text-gray-600",children:"Товары"}),e.jsx("th",{className:"px-4 py-3 text-center font-medium text-gray-600",children:"Действия"})]})}),e.jsx("tbody",{children:j?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"px-4 py-12 text-center",children:e.jsx(f,{className:"w-8 h-8 animate-spin mx-auto"})})}):w?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"px-4 py-12 text-center text-red-600",children:"Ошибка загрузки отгрузок"})}):g.length===0?e.jsx("tr",{children:e.jsxs("td",{colSpan:8,className:"px-4 py-12 text-center text-gray-500",children:[e.jsx(I,{className:"w-12 h-12 mx-auto mb-2 opacity-50"}),e.jsx("p",{children:l||r!=="ALL"?"Ничего не найдено":"Отгрузок пока нет"})]})}):g.map(t=>{var a,o;return e.jsxs("tr",{className:"border-b hover:bg-gray-50",children:[e.jsx("td",{className:"px-4 py-3 whitespace-nowrap",children:e.jsxs("div",{className:"text-xs",children:[A(new Date(t.createdAt),"dd.MM.yyyy",{locale:E}),e.jsx("br",{}),e.jsx("span",{className:"text-gray-500",children:A(new Date(t.createdAt),"HH:mm",{locale:E})})]})}),e.jsx("td",{className:"px-4 py-3 whitespace-nowrap",children:t.orderNumber?e.jsx("span",{className:"px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs font-medium",children:t.orderNumber}):e.jsx("span",{className:"text-gray-400 text-xs",children:"—"})}),e.jsx("td",{className:"px-4 py-3 whitespace-nowrap",children:k(t.status)}),e.jsx("td",{className:"px-4 py-3",children:e.jsx("div",{className:"max-w-[150px] truncate",title:t.customerName,children:t.customerName})}),e.jsx("td",{className:"px-4 py-3 whitespace-nowrap",children:t.customerPhone}),e.jsx("td",{className:"px-4 py-3",children:e.jsx("div",{className:"max-w-[200px] truncate",title:t.deliveryAddress,children:t.deliveryAddress})}),e.jsx("td",{className:"px-4 py-3",children:e.jsx("div",{className:"space-y-1",children:t.items.map(c=>{var m;return e.jsxs("div",{className:"text-xs",children:[e.jsx("span",{className:"font-medium",children:((m=c.inventoryItem)==null?void 0:m.name)||"—"}),e.jsxs("span",{className:"text-gray-500",children:[" × ",c.quantity]})]},c.id)})})}),e.jsx("td",{className:"px-4 py-3",children:e.jsxs("div",{className:"flex items-center justify-center gap-1",children:[e.jsx(x,{onClick:()=>z(t.id),disabled:h===t.id,size:"sm",variant:"outline",className:"gap-1",title:"Печать путевого листа",children:h===t.id?e.jsx(f,{className:"w-3 h-3 animate-spin"}):e.jsx(Q,{className:"w-3 h-3"})}),t.status===d.PENDING&&e.jsxs(x,{onClick:()=>v(t.id,d.IN_TRANSIT),disabled:u.isPending,size:"sm",className:"gap-1 bg-blue-600 hover:bg-blue-700",title:"Отправить в путь",children:[e.jsx(C,{className:"w-3 h-3"}),e.jsx("span",{className:"hidden sm:inline",children:"В путь"})]}),t.status===d.IN_TRANSIT&&(((a=i==null?void 0:i.role)==null?void 0:a.code)==="MANAGER"||((o=i==null?void 0:i.role)==null?void 0:o.code)==="OWNER")&&e.jsxs(x,{onClick:()=>v(t.id,d.DELIVERED),disabled:u.isPending,size:"sm",className:"gap-1 bg-green-600 hover:bg-green-700",title:"Отметить как доставлено",children:[e.jsx(D,{className:"w-3 h-3"}),e.jsx("span",{className:"hidden sm:inline",children:"Доставлено"})]})]})})]},t.id)})})]})}),g.length>0&&e.jsxs("div",{className:"px-4 py-3 bg-gray-50 border-t text-sm text-gray-600",children:["Показано отгрузок: ",e.jsx("span",{className:"font-semibold",children:g.length}),(l||r!=="ALL")&&p&&e.jsxs("span",{className:"ml-2",children:["из ",p.length]})]})]})})]})};export{K as ShipmentsPage};
