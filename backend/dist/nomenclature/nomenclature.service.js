...
let NomenclatureService = class NomenclatureService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findOne(id) {
        ...
        if (!nomenclature) {
            throw new common_1.NotFoundException(`Номенклатура с ID "${id}" не найдена`);
        }
        return nomenclature;
    }
...
//# sourceMappingURL=nomenclature.service.js.map