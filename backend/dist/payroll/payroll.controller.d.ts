...
export declare class PayrollController {
    ...
    getMyEarnings(user: AuthenticatedUser, startDate?: string, endDate?: string): Promise<{
        user: {
            id: string;
            firstName: string;
            lastName: string;
    ...
    getMyEarningsToday(user: AuthenticatedUser): Promise<{
        user: {
            id: string;
            firstName: string;
            lastName: string;
    ...
    getPayrollSummary(periodStart: string, periodEnd: string, userId?: string): Promise<{
        period: {
            start: string;
            end: string;
        };
